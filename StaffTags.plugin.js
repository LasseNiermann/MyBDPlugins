...
(function () {
	...
	// Process LASSE
        members.filter((_, e) => getUserId(e) === "268737698397814784").not(".kawaii-tagged")
            .after(addTag)
            .addClass("kawaii-tagged");

        // User profile popout
        mutationFind(mutation, ".userPopout-4pfA0d .headerTag-3zin_i")
            .filter((_, e) => getUserId(e) === "268737698397814784").not(".kawaii-tagged")
            .append($("<span>", {class: "kawaii-tag kawaii-tag-invert header-kawaii-tag"}).text("LASSE"))
            .addClass("kawaii-tagged");

        // Fullscreen popout (modal)
        mutationFind(mutation, ".header-info-inner .discord-tag")
            .filter((_, e) => getUserId(e) === "268737698397814784").not(".kawaii-tagged")
            .append($("<span>", {class: "kawaii-tag"}).text("LASSE"))
            .addClass("kawaii-tagged");
    ...
    StaffTag.prototype.start = function () {
    ...
    StaffTag.prototype.observer = function (mutation) {
        processServer(mutation);
        processProfile(mutation);
    };

    StaffTag.prototype.load = function () {};

    StaffTag.prototype.unload = function () {};

    StaffTag.prototype.stop = function () {
    ...
    StaffTag.prototype.getSettingsPanel = function () {
        return "";
    };

    StaffTag.prototype.getName = function () {
        return "Staff Tags";
    };

    StaffTag.prototype.getDescription = function () {
        return "Show the Staff Tag next to the Username.";
    };

    StaffTag.prototype.getVersion = function () {
        return "1.0.1";
    };

    StaffTag.prototype.getAuthor = function () {
        return "Lasse";
    };
})();
